...
import 'package:new_login/ui/widgets/customappbar.dart';
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.purpleAccent[200], Colors.blueAccent],
                ),
              ),
            ),
          ),
...
//        height: _height / 20,
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: <Color>[Colors.blueAccent[200], Colors.purpleAccent],
          ),
        ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          CircleAvatar(
            radius: 15,
            backgroundImage: AssetImage("assests/images/googlelogo.png"),
          ),
          SizedBox(
            width: 20,
          ),
          CircleAvatar(
            radius: 15,
            backgroundImage: AssetImage("assests/images/fblogo.jpg"),
          ),
          SizedBox(
            width: 20,
          ),
          CircleAvatar(
            radius: 15,
            backgroundImage: AssetImage("assests/images/twitterlogo.jpg"),
          ),
        ],
      ),
    );
